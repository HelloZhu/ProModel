...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    if ([urlString containsString:@"weixin://wap/pay?"] || [urlString containsString:@"itunes.apple.com"]||[urlString containsString:@"itms-services://?action=download"]||[urlString containsString:@"alipay://"]||[urlString containsString:@"alipays://"]||[urlString containsString:@"mqqwallet://"]||[urlString containsString:@"mqqapi://"]) {
